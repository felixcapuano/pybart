...
class Ui_ConfigPanel(object):
    def setupUi(self, ConfigPanel):
        ...
        self.button_start.setGeometry(QtCore.QRect(450, 590, 61, 31))
        self.button_start.setObjectName("button_start")
        self.button_stop = QtWidgets.QPushButton(self.centralwidget)
        self.button_stop.setEnabled(False)
        self.button_stop.setGeometry(QtCore.QRect(380, 590, 61, 31))
        self.button_stop.setAutoDefault(False)
        self.button_stop.setDefault(False)
        self.button_stop.setFlat(False)
        self.button_stop.setObjectName("button_stop")
        self.commandBox = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.commandBox.setEnabled(True)
        self.commandBox.setGeometry(QtCore.QRect(10, 590, 361, 91))
        self.commandBox.setReadOnly(True)
        self.commandBox.setObjectName("commandBox")
        self.widget_configuration = QtWidgets.QWidget(self.centralwidget)
        self.widget_configuration.setEnabled(True)
        self.widget_configuration.setGeometry(QtCore.QRect(-1, 0, 521, 581))
        self.widget_configuration.setObjectName("widget_configuration")
        self.groupBox = QtWidgets.QGroupBox(self.widget_configuration)
        self.groupBox.setGeometry(QtCore.QRect(10, 0, 501, 151))
        self.groupBox.setObjectName("groupBox")
        self.groupBox_4 = QtWidgets.QGroupBox(self.groupBox)
        self.groupBox_4.setGeometry(QtCore.QRect(10, 100, 481, 41))
        ...
        self.frame_select_file.setGeometry(QtCore.QRect(80, 10, 391, 21))
        ...
        self.label_filename.setGeometry(QtCore.QRect(80, 0, 301, 21))
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(self.widget_configuration)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 160, 501, 51))
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.widget_configuration)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 220, 501, 301))
        self.groupBox_2.setObjectName("groupBox_2")
        self.table_trigs_params = QtWidgets.QTableWidget(self.groupBox_2)
        self.table_trigs_params.setGeometry(QtCore.QRect(10, 50, 481, 241))
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(self.widget_configuration)
        self.groupBox_6.setGeometry(QtCore.QRect(10, 530, 501, 51))
    ...
    def retranslateUi(self, ConfigPanel):
        ...
        self.line_low_freq.setText(_translate("ConfigPanel", "0.5"))
