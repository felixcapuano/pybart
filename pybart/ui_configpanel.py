...
class Ui_ConfigPanel(object):
    def setupUi(self, ConfigPanelUI):
        ConfigPanelUI.setObjectName("ConfigPanelUI")
        ConfigPanelUI.resize(532, 616)
        ConfigPanelUI.setContextMenuPolicy(QtCore.Qt.CustomContextMenu)
        self.centralwidget = QtWidgets.QWidget(ConfigPanelUI)
        ...
        ConfigPanelUI.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(ConfigPanelUI)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 532, 21))
        self.menubar.setObjectName("menubar")
        ConfigPanelUI.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(ConfigPanelUI)
        self.statusbar.setObjectName("statusbar")
        ConfigPanelUI.setStatusBar(self.statusbar)

        self.retranslateUi(ConfigPanelUI)
        QtCore.QMetaObject.connectSlotsByName(ConfigPanelUI)

    def retranslateUi(self, ConfigPanelUI):
        _translate = QtCore.QCoreApplication.translate
        ConfigPanelUI.setWindowTitle(_translate("ConfigPanelUI", "Configuration Panel"))
        self.groupBox.setTitle(_translate("ConfigPanelUI", "Brainamp configuation"))
        self.label_host.setText(_translate("ConfigPanelUI", "Host"))
        self.label_port.setText(_translate("ConfigPanelUI", "Port"))
        self.line_host.setText(_translate("ConfigPanelUI", "127.0.0.1"))
        self.line_port.setText(_translate("ConfigPanelUI", "51244"))
        self.groupBox_2.setTitle(_translate("ConfigPanelUI", "Trigger configuration"))
        item = self.table_trigs_params.horizontalHeaderItem(0)
        item.setText(_translate("ConfigPanelUI", "label"))
        item = self.table_trigs_params.horizontalHeaderItem(1)
        item.setText(_translate("ConfigPanelUI", "left sweep"))
        item = self.table_trigs_params.horizontalHeaderItem(2)
        item.setText(_translate("ConfigPanelUI", "right sweep"))
        item = self.table_trigs_params.horizontalHeaderItem(3)
        item.setText(_translate("ConfigPanelUI", "max stack"))
        # self.combo_program.setItemText(0, _translate("ConfigPanelUI", "New Parameters"))
        self.label.setText(_translate("ConfigPanelUI", "Detected"))
        self.button_start.setText(_translate("ConfigPanelUI", "Start"))
        self.button_stop.setText(_translate("ConfigPanelUI", "Stop"))
        self.groupBox_3.setTitle(_translate("ConfigPanelUI", "Passband Filter"))
        self.line_low_freq.setText(_translate("ConfigPanelUI", "1"))
        self.line_high_freq.setText(_translate("ConfigPanelUI", "20"))
        self.label_low.setText(_translate("ConfigPanelUI", "Low"))
        self.label_high.setText(_translate("ConfigPanelUI", "High"))
        self.checkBox_trigEmul.setText(_translate("ConfigPanelUI", "triggers emulation"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    ConfigPanelUI = QtWidgets.QMainWindow()
    ui = Ui_ConfigPanel()
    ui.setupUi(ConfigPanelUI)
    ConfigPanelUI.show()
    sys.exit(app.exec_())
